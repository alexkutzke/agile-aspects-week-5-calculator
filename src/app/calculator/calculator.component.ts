...
export class CalculatorComponent implements OnInit {
  ...
  private quotientDiv: number = 0;
  private remainderDiv: number|undefined = 0;
  ...
  constructor(
    ...
    private divideBySubtraction: DivideBySubtractionService
  ) { }
  ...
  subtract(num1: number, num2: number){
    this.subRes = this.subtractService.subtract(num1,num2);
  }

  divide(num1: number, num2: number){
    let divRes = this.divideBySubtraction.divide(num1,num2);
    this.quotientDiv = divRes[0];
    this.remainderDiv = divRes[1];
  }
  ...
  get quotient(){
    return this.quotientDiv;
  }

  get remainder(){
    return this.remainderDiv
  }
