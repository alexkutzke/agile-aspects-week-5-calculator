...
export class CalculatorComponent implements OnInit {
  ...
  constructor(
    ...
    private subService: SubtractionService,
    private divideService: DivideBySubService
  ) { }
  ...
  subtract(num1: number, num2: number) {
    this.subRes = this.subService.subtraction(num1, num2);
  }

  divide(num1: number, num2: number){
    this.divRes = this.divideService.divide(num1, num2);
  }
