...
export class CalculatorComponent implements OnInit {
  ...
  constructor(
    ...
    private divisionBySubtractService: DivisionBySubtractService
  ) { }
  ...
  subtract(num1: number, num2: number){
    this.subRes = this.subtractionService.subtract(num1, num2);
  }

  divide(num1: number, num2: number){
    this.divRes = this.divisionBySubtractService.divide(num1, num2);
  }
