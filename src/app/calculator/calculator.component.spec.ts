...
describe('CalculatorComponent', () => {
  ...
  it('should present results 5, 6 and 8 after calculate(2,3)', () => {
    ...
    expect(resultSumInput.value).toBe('14');
    expect(resultSubInput.value).toBe('10');
    expect(resultMultiplyInput.value).toBe('24');
    expect(resultDivisionInput.value).toBe('6');
    expect(resultPowerInput.value).toBe('144');
  });
