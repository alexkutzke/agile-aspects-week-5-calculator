...
describe('CalculatorComponent', () => {
  ...
  it('should present results 5, 6, 8, -1, 0, 2 after calculate(2,3)', () => {
    ...
    const resultSubtractInput:HTMLInputElement = compiled.querySelector('#resultSubtract')!;
    const quotientDivideInput:HTMLInputElement = compiled.querySelector('#quotientDivide')!;
    const remainderDivideInput:HTMLInputElement = compiled.querySelector('#remainderDivide')!;
    ...
    expect(quotientDivideInput.value).toBe('0');
    expect(remainderDivideInput.value).toBe('2');
  });
  
  it('should present results 5, 6, 8, -1, 0, 2 after user enter values 2 and 3 then click the button', () => {
    const compiled = fixture.nativeElement as HTMLElement;
