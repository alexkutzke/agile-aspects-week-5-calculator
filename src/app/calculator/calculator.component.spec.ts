...
describe('CalculatorComponent', () => {
  ...
  it('should present results 5, 6, 8, -1 and 0 after calculate(2,3)', () => {
    ...
    expect(resultSubInput.value).toBe('-1');
    expect(resultDivInput.value).toBe('0');
  });
  
  it('should present results 5, 6, 8, -1 and 0 after user enter values 2 and 3 then click the button', () => {
    const compiled = fixture.nativeElement as HTMLElement;
